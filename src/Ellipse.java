...
public class Ellipse extends BigShape {

	public Ellipse(int a, int b, int c, int d, Color e, Color f) {
		super(a, b, c, d, e, f);
		// TODO Auto-generated constructor stub
	}

	public Shape getShape() {
		Shape Ellipse = new Ellipse2D.Double(p1x, p1y, Math.abs(x1 - x2),
				Math.abs(y1 - y2));
		return Ellipse;
	}
	...
	public double getArea() {
		double area = ((p2x - p1x) / 2) * ((p3y - p1y) / 2) * 3.14;
		return area;
	}
